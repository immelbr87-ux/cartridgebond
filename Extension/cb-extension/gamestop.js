...
const GS_GAMES = [
  ...
  { keys: ['tears of the kingdom', 'zelda totk'],  title: 'Zelda: TOTK',             price: 50, gsPrice: 24 },
  { keys: ['breath of the wild', 'zelda botw'],    title: 'Zelda: BOTW',             price: 35, gsPrice: 15 },
  { keys: ['smash bros ultimate', 'super smash'],  title: 'Smash Bros Ultimate',     price: 31, gsPrice: 14 },
  { keys: ['mario odyssey', 'super mario odyssey'],title: 'Mario Odyssey',           price: 38, gsPrice: 16 },
  { keys: ['mario bros wonder', 'mario wonder'],   title: 'Mario Wonder',            price: 45, gsPrice: 20 },
  { keys: ['animal crossing new horizons'],        title: 'Animal Crossing NH',      price: 36, gsPrice: 14 },
  { keys: ['pokemon scarlet'],                     title: 'Pokemon Scarlet',         price: 39, gsPrice: 16 },
  { keys: ['pokemon violet'],                      title: 'Pokemon Violet',          price: 38, gsPrice: 16 },
  { keys: ['splatoon 3'],                          title: 'Splatoon 3',              price: 34, gsPrice: 12 },
  { keys: ["luigi's mansion 3", 'luigis mansion'], title: "Luigi's Mansion 3",       price: 32, gsPrice: 12 },
  { keys: ['kirby forgotten land'],                title: 'Kirby Forgotten Land',    price: 32, gsPrice: 12 },
  { keys: ['metroid dread'],                       title: 'Metroid Dread',           price: 30, gsPrice: 10 },
];
